...
from ktalk_mcp.client import AuthStatus, KTalkClient, KTalkError
from ktalk_mcp.config import AuthMode, KTalkConfigError, Settings, redact_secrets
from ktalk_mcp.enrichment import enrich_batch, map_participants
from ktalk_mcp.pagination import clip_to_window, paginate_pages, skip_pages, token_pages
from ktalk_mcp.reconciliation import dry_run_report, recording_ids
from ktalk_mcp.registry import Registry, recording_fields_from_api
...
def cmd_sync(reg: Registry, args) -> int:
    ...
    if args.json:
        ...
        return 0
    from ktalk_mcp.cli import _cmd_dashboard
