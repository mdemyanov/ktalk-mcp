...
| [rooms-calendar-spec.md](rooms-calendar-spec.md) | Раскладка реализации волны «комнаты, календарь, планирование» (0.6.0) по файлам под гейт C13: `OPERATION_PROFILES`, мапперы, сегментация, протокол подтверждения, FR-19 |
